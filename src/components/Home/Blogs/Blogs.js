            ...
            <div className="container">
                <div className="row">
                    <div className="col my-5 mx-4 border-4 rounded-2 p-4 bg-light">
                        <h6 className='text-color'><i class="fa-solid fa-hand-point-right"></i> Difference between javascript and nodejs</h6>
                        ...
                        <h6 className='text-color'><i class="fa-solid fa-hand-point-right"></i> When should you use nodejs and when should you use mongodb</h6>
                        ...
                        <h6 className='text-color'><i class="fa-solid fa-hand-point-right"></i> Differences between sql and nosql databases</h6>
                        ...
                        <h6 className='text-color'><i class="fa-solid fa-hand-point-right"></i>  What is the purpose of jwt and how does it work</h6>
